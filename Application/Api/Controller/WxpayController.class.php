...
class WxpayController extends BaseController
{
    public function _initialize()
    {
        ...
        require_once "plugins/payment/weixin/lib/WxPay.Config.php";
        require_once "plugins/payment/weixin/lib/WxPay.Data.php";
        require_once "plugins/payment/weixin/lib/WxPay.Exception.php";
...
//        require_once("plugins/payment/weixin/lib/WxPay.Exception.php");
        ...
        $notifurl = $_SERVER['HTTP_HOST']."/index.php?m=api&c=Wxpay&a=notify";
        //$WxPayConfig = \WxPayConfig::getInstance();
        $unifiedOrder->SetAppid($this->appid);//appid
        $unifiedOrder->SetMch_id($this->mchid);//商户标识
        ...
        $unifiedOrder->SetNotify_url($notifurl);//交易成功通知url
