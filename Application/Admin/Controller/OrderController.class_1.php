...
class OrderController extends BaseController {
    ...
    public function ajaxindex(){
        ...
        $suppliers=M('admin')->join('__SUPPLIERS__ ON __ADMIN__.admin_id = '.$adminid.'  and __ADMIN__.suppliers_id=__SUPPLIERS__.suppliers_id')->select();
        ...
        if($adminid==1){
            ...
            $orderby='tptc_order_goods.order_id desc';
            $orderList=$orderLogic->getSuppliersOrderList($suppliers_id,$orderby,$Page->firstRow,$Page->listRows);
        }
