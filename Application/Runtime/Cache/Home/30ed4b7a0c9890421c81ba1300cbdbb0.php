...
<div class="setout">
    <div class="login-area">
        ...
        <span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'weixin'));?>"><i class="wei-xin"></i></a></span>
<!--       <span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'alipay'));?>"><i class="zhi-y-f"></i></a></span>-->
        ...
        <p class="nu-miaf nu-miah"><label for="1"><!-- 继续登录表明您已充分理解并同意以上内容。 --></label></p>
    </div>
</div>
<div class="hr-60"></div>
